...
public class Main {
    public static void main(String[] args) {
        ...
        Caissier caissier1 = new Caissier(1, "irad", "Adresse1", 160, 1);
        Caissier caissier2 = new Caissier(1, "samir", "Adresse1", 160, 2);
        Vendeur vendeur1 = new Vendeur(2, "jamil", "Adresse2", 160, 0.8);
        ...
        Caissier caissier3 = new Caissier(1, "fathi", "Adresse1", 160, 3);
        Vendeur vendeur2 = new Vendeur(2, "selm", "Adresse2", 160, 0.8);
        Vendeur vendeur3 = new Vendeur(2, "ahmed", "Adresse2", 160, 0.8);
        Vendeur vendeur4 = new Vendeur(2, "abdesalem", "Adresse2", 160, 0.8);
        Responsable responsable2 = new Responsable(3, "amir", "Adresse3", 160, 200);
        ...
        System.out.println(vendeur3.calculsalaire());
        System.out.println("les salaire vendeur 2de monoprix");

        System.out.println(vendeur4.calculsalaire());
